...
namespace Assessment.GlobalKinetic.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly GlobalKineticDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = GlobalKineticConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(GlobalKineticDbContext context)
        {
            _context = context;
        }
