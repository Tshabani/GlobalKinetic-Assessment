...
{
    public abstract class GlobalKineticWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GlobalKineticWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GlobalKineticWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GlobalKineticDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GlobalKineticDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GlobalKineticDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GlobalKineticDbContext, Task<T>> func)
        {
            T result;
